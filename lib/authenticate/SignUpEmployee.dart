              ...
              children: <Widget>[
                Directionality(
                  ...
                  child: TextFormField(
                    ...
                    validator: (val) => val.isEmpty ? 'الرجاء إدخال الإسم الأول' : null,
                ...
                Directionality(
                  ...
                  child: TextFormField(
                    textInputAction: TextInputAction.done,
                    style: TextStyle(fontSize: customeFontSize),
                    decoration: textInputDecoration.copyWith(alignLabelWithHint: false,
                        errorStyle: TextStyle(color: Colors.red.shade500),
                        hintText: "ادخل إسم العائلة",
                        labelText: " إسم العائلة"),
                    validator: (val) => val.isEmpty ? 'الرجاء إدخال اسم العائلة' : null,
                    onChanged: (String val) {
                      setState(() {
                        lastname = val;
                      });
                ...
                Directionality(
                  ...
                  child: TextFormField(
                    ...
                    validator: (String val) => EmailValidator.validate(email)
                        ? null
                ...
                Directionality(
                  ...
                  child: TextFormField(
                    ...
                    textAlign: TextAlign.right,
                    decoration: textInputDecoration.copyWith(hintText: "ادخل رقم الهاتف",
                    ...
                    Column(
                      children: <Widget>[
                        Container(
                          child: Text(
                            "اختر وظيفة",
                            style: TextStyle(fontSize: 22.0, letterSpacing: 4.0),
                            textDirection: TextDirection.rtl,
                          ),
                    ...
                    onPressed: () async {
                      if (_formKey.currentState.validate()) {
                        ...
                        if (result == null) {
                          loading = false;
                          setState(() =>
                              error = 'تعذر التسجيل تأكد من حسابك و كلمة السر');
                        }
                        userID = await AuthService().getUserDoc();
                        try {
                          _firestore.collection(currentJob).add({
                            'name': firstname,
                            'lastname': lastname,
